        ...
        <v-form ref="form">
          <v-container>
            ...
            <v-row>
              <v-col cols="12" md="4">
                <v-select
                  ...
                  :items="select.purchaseUnit"
                  required
                  label="Purchas Unit"
                />
                <v-select
                  v-model="form.stockUnit"
                  :items="select.stockUnit"
                  required
                  label="Stock Unit"
                />
              </v-col>
              <v-col cols="12" md="8">
                ...
                />
                <v-text-field
                  v-model="form.stockConversionQuantity"
                  required
                  type="number"
                  hide-spin-buttons
            ...
            <v-row>
              <v-col cols="12" md="12">
                <AppCurrencyField
                  v-model.number="form.supplyPrice"
                  disabled
                  label="Supply Price"
                />
                <AppCurrencyField
                  v-model.number="form.valueAddedTax"
                  disabled
                  label="Value Added Tax"
                />
                <v-text-field
                  v-model="form.stockUnitPrice"
                  disabled
                  type="number"
